...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#080c12] text-white relative overflow-x-hidden font-geist">
      ...
      <div
        className="absolute top-0 left-0 w-full h-[843px] z-0 pointer-events-none"
        style={{
          background:
            "linear-gradient(57.34deg, rgba(246, 70, 70, 0.44) 66.95%, rgba(144, 41, 41, 0) 71.1%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto min-h-[1080px]">
        ...
        <div className="absolute top-[128px] left-[478px] w-[1020px]">
          <h1
            className="text-[64px] text-center font-extrabold leading-[1.076]"
            style={{ fontFamily: "Geist, sans-serif", fontWeight: 800 }}
          >
            Your <span className="text-[#ff4c4c]">Items</span>, Ready to{" "}
            <span className="text-[#ff4c4c]">Buy</span> or{" "}
            <span className="text-[#ff4c4c]">Sell</span> <br />
            {"            "}in Just a{" "}
            <span className="text-[#ff4c4c]">Few Clicks</span>.
          </h1>
        </div>
        ...
        <div className="absolute top-[300px] left-[585px] w-[740px]">
          <p
            className="text-[24px] font-medium leading-[1.076]"
        ...
        <div className="absolute top-[418px] left-[793px] w-[395px] h-[90px]">
          ...
          >
            ...
            <span
              className="text-[20px] font-extrabold leading-[1.076] text-white"
              style={{ fontFamily: "Geist, sans-serif" }}
            >
              Start Trading Now!
            </span>
